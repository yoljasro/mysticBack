...
class Property extends BaseProperty {
    ...
    subProperties() {
        if (this.type() === 'mixed' && this.mongoosePath.caster && this.mongoosePath.caster.schema) {
    ...
    type() {
        if (this.isArray()) {
            if (!this.mongoosePath.caster) {
                return this.instanceToType(this.mongoosePath.options.type?.[0]?.name || 'String');
            }
