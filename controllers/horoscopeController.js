...
const getHoroscope = asyncHandler(async (req, res) => {
    ...
    if (!horoscope) {
        ...
        if (type === 'weekly') {
            predictions = {
                general: "На этой неделе звезды обещают вам много интересных событий. Проявите инициативу.",
                love: "Эта неделя принесет гармонию в личные отношения и приятные сюрпризы.",
                career: "На работе возможны новые проекты и перспективы. Будьте готовы к вызовам.",
                health: "Поддерживайте иммунитет, больше гуляйте на свежем воздухе и отдыхайте."
            };
        } else if (type === 'monthly') {
            predictions = {
                general: "Этот месяц станет для вас временем важных решений и глобальных перемен.",
                love: "В этом месяце вас ждут глубокие чувства, романтика и взаимопонимание.",
                career: "Отличный месяц для карьерного роста, инвестиций и достижения долгосрочных целей.",
                health: "Обратите внимание на свое самочувствие в этом месяце, избегайте стрессов."
            };
        } else {
            predictions = {
                general: "Звезды сегодня приготовили для вас что-то особенное. Будьте внимательны к знакам.",
                love: "Сегодня отличный день для романтики и укрепления отношений.",
                career: "Ваш путь к успеху сегодня чист. Сосредоточьтесь на главных задачах.",
                health: "Берегите себя и свои силы сегодня. Найдите время для релаксации."
            };
        }
        ...
        return res.status(200).json({
            ...
            luckyColor: type === 'monthly' ? "Purple" : (type === 'weekly' ? "Green" : "Azure"),
